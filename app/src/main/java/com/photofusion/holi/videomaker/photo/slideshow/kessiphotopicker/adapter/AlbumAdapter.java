package com.photofusion.holi.videomaker.photo.slideshow.kessiphotopicker.adapter;
...
//        holder.imageItem.setBackground();
        Glide.with(this.context).load(new File(item.getPathFile())).into(holder.imageItem);
