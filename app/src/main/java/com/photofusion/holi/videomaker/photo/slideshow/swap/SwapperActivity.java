package com.photofusion.holi.videomaker.photo.slideshow.swap;
...
import com.photofusion.holi.videomaker.photo.slideshow.gridsupport.AbsDynamicGridView;
...
public class SwapperActivity extends BaseActivity implements View.OnClickListener {
...
//            //admob
//            AdAdmob.initAd(SwapperActivity.this);
//            AdAdmob.loadBannerAd(SwapperActivity.this, adContainer);
//            AdAdmob.loadInterAd(SwapperActivity.this);
//        } else {
//            //MAX + Fb banner Ads
//            AdAdmob.initMAX(SwapperActivity.this);
//            AdAdmob.maxBanner(SwapperActivity.this, adContainer);
//            AdAdmob.maxInterstital(SwapperActivity.this);
//        }
//    }
...
//            if (!AdAdmob.isloadFbMAXAd) {
//                AdAdmob.showInterAd(SwapperActivity.this, null, 0);
//            } else {
//                AdAdmob.showMaxInterstitial(SwapperActivity.this, null, 0);
//            }
//        } else {
...
//            startActivityes(new Intent(ZapperActivity.this, DecorFrmActivity.class),0);
        }
    }
...
//        if (!AdAdmob.isloadFbMAXAd) {
//            AdAdmob.adCounter++;
//            AdAdmob.showInterAd(SwapperActivity.this, intent, reqCode);
//        } else {
//            AdAdmob.adCounter++;
//            AdAdmob.showMaxInterstitial(SwapperActivity.this, intent, reqCode);
//        }
//    }
