package com.photofusion.holi.videomaker.photo.slideshow.song;
...
public class SongGalleryActivity extends BaseActivity implements MarkerView.MarkerListener, WaveformView.WaveformListener {
        ...
        mStartText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (mStartText.hasFocus()) {
                    try {
                        mStartPos = mPVMWSWaveformView.secondsToPixels(Double.parseDouble(mStartText.getText().toString()));
                        updateDisplay();
                ...
                if (mEndText.hasFocus()) {
                    try {
                        mEndPos = mPVMWSWaveformView.secondsToPixels(Double.parseDouble(mEndText.getText().toString()));
                        updateDisplay();
    ...
    public class LoadMusics extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... paramVarArgs) {
            ...
            if (mPVMWSMusicData.size() > 0) {
                ...
                Log.e("doInBackground: ", mFilename);
            } else {
                mFilename = "record";
            }
            return null;
...
//            pDialog.dismiss();
    ...
    public class MusicAdapter extends RecyclerView.Adapter<MusicAdapter.Holder> {
        ...
        public void onBindViewHolder(Holder holder, @SuppressLint("RecyclerView") final int pos) {
            ...
            Log.e("aaaaaaaaaaa: ", PVMWSMusicData.get(pos).track_displayName);
            ...
            holder.musicName.setOnClickListener(new OnClickListener() {
                public void onClick(View arg0) {
                    ...
                    if (mIsPlaying) {
                        ...
                        notifyDataSetChanged();// Pause the current track
                    }
                   else  {
                        booleanArray.clear();
                        booleanArray.put(pos, true);
