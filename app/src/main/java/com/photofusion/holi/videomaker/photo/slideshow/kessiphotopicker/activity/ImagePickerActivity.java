package com.photofusion.holi.videomaker.photo.slideshow.kessiphotopicker.activity;
...
import com.photofusion.holi.videomaker.photo.slideshow.kessiphotopicker.adapter.ListAlbumAdapter;
import com.photofusion.holi.videomaker.photo.slideshow.kessiphotopicker.model.ImageModel;
import com.photofusion.holi.videomaker.photo.slideshow.kessiphotopicker.myinterface.IHandler;
import com.photofusion.holi.videomaker.photo.slideshow.kessiphotopicker.myinterface.OnAlbum;
import com.photofusion.holi.videomaker.photo.slideshow.kessiphotopicker.myinterface.OnListAlbum;
...
public class ImagePickerActivity extends BaseActivity implements OnClickListener, OnAlbum, OnListAlbum {
...
//            //admob
//            AdAdmob.initAd(ImagePickerActivity.this);
//            AdAdmob.loadBannerAd(ImagePickerActivity.this, adContainer);
//            AdAdmob.loadInterAd(ImagePickerActivity.this);
//        } else {
//            //MAX + Fb banner Ads
//            AdAdmob.initMAX(ImagePickerActivity.this);
//            AdAdmob.maxBanner(ImagePickerActivity.this, adContainer);
//            AdAdmob.maxInterstital(ImagePickerActivity.this);
//        }
//    }
...
//            if (!AdAdmob.isloadFbMAXAd) {
//                AdAdmob.showInterAd(ImagePickerActivity.this, null, 0);
//            } else {
//                AdAdmob.showMaxInterstitial(ImagePickerActivity.this, null, 0);
//            }
//        } else {
...
//    }
    ...
    void addItemSelect(final ImageModel item) {
        ...
        Glide.with((Activity) this).load(item.getPathFile()).into(imageItem);
